...
/**
 * Continuous integration (Local work executor)
 */

module com.io7m.northpike.agent.workexec.local
{
  ...
  requires com.io7m.northpike.tools.common;
  ...
  provides NPAWorkExecutorFactoryType
    with NPWorkExecutorsLocal;

  exports com.io7m.northpike.agent.workexec.local;
  exports com.io7m.northpike.agent.workexec.local.cb;
}
