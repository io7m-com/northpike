...
import static com.io7m.northpike.protocol.user.cb.internal.NPUVToolExecutionDescriptionSearchParameters.TOOL_EXECUTION_DESCRIPTION_SEARCH_PARAMETERS;

/**
 * A validator.
 */

public enum NPUVCommandToolExecutionDescriptionSearchBegin
  ...
  NPU1CommandToolExecutionDescriptionSearchBegin>
{
  ...
  COMMAND_TOOL_EXECUTION_DESCRIPTION_SEARCH_BEGIN;
    ...
    final NPUCommandToolExecutionDescriptionSearchBegin message)
  {
    return new NPU1CommandToolExecutionDescriptionSearchBegin(
      ...
      TOOL_EXECUTION_DESCRIPTION_SEARCH_PARAMETERS.convertToWire(message.parameters())
    );
  }
    ...
    final NPU1CommandToolExecutionDescriptionSearchBegin message)
  {
    return new NPUCommandToolExecutionDescriptionSearchBegin(
      ...
      TOOL_EXECUTION_DESCRIPTION_SEARCH_PARAMETERS.convertFromWire(message.fieldParameters())
    );
  }
}
