...
import com.io7m.northpike.protocol.user.cb.NPU1ResponsePlanSearch;

import static com.io7m.cedarbridge.runtime.api.CBCore.unsigned32;
import static com.io7m.cedarbridge.runtime.api.CBCore.unsigned64;
import static com.io7m.northpike.protocol.user.cb.internal.NPUVPlanSummary.PLAN_SUMMARY;

/**
 * A validator.
 */

public enum NPUVResponsePlanSearch
  ...
  NPU1ResponsePlanSearch>
{
  ...
  RESPONSE_PLAN_SEARCH;

  @Override
  public NPU1ResponsePlanSearch convertToWire(
    final NPUResponsePlanSearch message)
  {
    return new NPU1ResponsePlanSearch(
      new CBUUID(message.messageID()),
      new CBUUID(message.correlationID()),
      new NPU1Page<>(
        CBLists.ofCollection(
          message.results().items(),
          PLAN_SUMMARY::convertToWire
        ),
  ...
  @Override
  public NPUResponsePlanSearch convertFromWire(
    final NPU1ResponsePlanSearch message)
  {
