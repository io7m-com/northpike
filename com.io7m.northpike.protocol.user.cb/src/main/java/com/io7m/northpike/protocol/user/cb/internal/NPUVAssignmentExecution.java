...
public enum NPUVAssignmentExecution
  implements NPProtocolMessageValidatorType<NPAssignmentExecution, NPU1AssignmentExecution>
{
  /**
   * A validator.
   */
  ...
  @Override
  public NPU1AssignmentExecution convertToWire(
  ...
  @Override
  public NPAssignmentExecution convertFromWire(
