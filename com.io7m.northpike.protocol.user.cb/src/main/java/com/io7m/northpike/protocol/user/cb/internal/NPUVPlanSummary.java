...
import com.io7m.northpike.protocol.user.cb.NPU1PlanSummary;
  ...
  NPU1PlanSummary>
{
  ...
  @Override
  public NPU1PlanSummary convertToWire(
    final NPPlanSummary message)
  {
    return new NPU1PlanSummary(
  ...
  @Override
  public NPPlanSummary convertFromWire(
    final NPU1PlanSummary message)
  {
