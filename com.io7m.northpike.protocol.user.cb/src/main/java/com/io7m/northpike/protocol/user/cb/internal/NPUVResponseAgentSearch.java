...
import com.io7m.northpike.protocol.user.cb.NPU1ResponseAgentSearch;

import static com.io7m.cedarbridge.runtime.api.CBCore.unsigned32;
import static com.io7m.cedarbridge.runtime.api.CBCore.unsigned64;
import static com.io7m.northpike.protocol.user.cb.internal.NPUVAgentSummary.AGENT_SUMMARY;

/**
 * A validator.
 */

public enum NPUVResponseAgentSearch
  implements NPProtocolMessageValidatorType<NPUResponseAgentSearch, NPU1ResponseAgentSearch>
{
  /**
   * A validator.
   */

  RESPONSE_AGENT_SEARCH;

  @Override
  public NPU1ResponseAgentSearch convertToWire(
    final NPUResponseAgentSearch message)
  {
    return new NPU1ResponseAgentSearch(
      new CBUUID(message.messageID()),
      new CBUUID(message.correlationID()),
      new NPU1Page<>(
        CBLists.ofCollection(
          message.results().items(),
          AGENT_SUMMARY::convertToWire
        ),
  ...
  @Override
  public NPUResponseAgentSearch convertFromWire(
    final NPU1ResponseAgentSearch message)
  {
