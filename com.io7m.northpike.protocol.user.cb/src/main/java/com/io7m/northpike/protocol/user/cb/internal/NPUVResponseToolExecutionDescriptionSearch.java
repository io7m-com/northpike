...
import com.io7m.northpike.protocol.user.cb.NPU1ResponseToolExecutionDescriptionSearch;

import static com.io7m.cedarbridge.runtime.api.CBCore.unsigned32;
import static com.io7m.cedarbridge.runtime.api.CBCore.unsigned64;
import static com.io7m.northpike.protocol.user.cb.internal.NPUVToolExecutionDescriptionSummary.TOOL_EXECUTION_DESCRIPTION_SUMMARY;

/**
 * A validator.
 */

public enum NPUVResponseToolExecutionDescriptionSearch
  ...
  NPU1ResponseToolExecutionDescriptionSearch>
{
  ...
  RESPONSE_TOOL_EXECUTION_DESCRIPTION_SEARCH;

  @Override
  public NPU1ResponseToolExecutionDescriptionSearch convertToWire(
    final NPUResponseToolExecutionDescriptionSearch message)
  {
    return new NPU1ResponseToolExecutionDescriptionSearch(
      new CBUUID(message.messageID()),
      new CBUUID(message.correlationID()),
      new NPU1Page<>(
        CBLists.ofCollection(
          message.results().items(),
          TOOL_EXECUTION_DESCRIPTION_SUMMARY::convertToWire
        ),
  ...
  @Override
  public NPUResponseToolExecutionDescriptionSearch convertFromWire(
    final NPU1ResponseToolExecutionDescriptionSearch message)
  {
    return new NPUResponseToolExecutionDescriptionSearch(
      ...
      new NPPage<>(
        CBLists.toList(
          ...
          TOOL_EXECUTION_DESCRIPTION_SUMMARY::convertFromWire
        ),
