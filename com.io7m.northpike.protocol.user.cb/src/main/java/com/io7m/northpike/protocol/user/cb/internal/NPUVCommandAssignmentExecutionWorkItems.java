...
public enum NPUVCommandAssignmentExecutionWorkItems
  ...
  NPU1CommandAssignmentExecutionWorkItems>
{
  ...
  COMMAND_ASSIGNMENT_EXECUTION_WORK_ITEMS;

  @Override
  public NPU1CommandAssignmentExecutionWorkItems convertToWire(
    final NPUCommandAssignmentExecutionWorkItems message)
  {
  ...
  @Override
  public NPUCommandAssignmentExecutionWorkItems convertFromWire(
    final NPU1CommandAssignmentExecutionWorkItems message)
  {
