...
import com.io7m.northpike.protocol.user.cb.NPU1ResponseAssignmentSearch;
...
public enum NPUVResponseAssignmentSearch
  ...
  NPU1ResponseAssignmentSearch>
{
  ...
  RESPONSE_ASSIGNMENT_SEARCH;

  @Override
  public NPU1ResponseAssignmentSearch convertToWire(
    final NPUResponseAssignmentSearch message)
  {
    return new NPU1ResponseAssignmentSearch(
      new CBUUID(message.messageID()),
      new CBUUID(message.correlationID()),
      new NPU1Page<>(
        CBLists.ofCollection(
          message.results().items(),
          ASSIGNMENT::convertToWire
        ),
  ...
  @Override
  public NPUResponseAssignmentSearch convertFromWire(
    final NPU1ResponseAssignmentSearch message)
  {
