...
public enum NPUVRepositoryDescription
  implements NPProtocolMessageValidatorType<NPRepositoryDescription, NPU1RepositoryDescription>
{
  /**
   * A validator.
   */
  ...
  @Override
  public NPU1RepositoryDescription convertToWire(
    final NPRepositoryDescription message)
  {
  ...
  @Override
  public NPRepositoryDescription convertFromWire(
    final NPU1RepositoryDescription message)
  {
