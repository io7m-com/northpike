...
import com.io7m.northpike.protocol.user.cb.NPU1ResponsePublicKeySearch;
...
public enum NPUVResponsePublicKeySearch
  implements NPProtocolMessageValidatorType<NPUResponsePublicKeySearch, NPU1ResponsePublicKeySearch>
{
  /**
   * A validator.
   */

  RESPONSE_PUBLIC_KEY_SEARCH;

  @Override
  public NPU1ResponsePublicKeySearch convertToWire(
    final NPUResponsePublicKeySearch message)
  {
    return new NPU1ResponsePublicKeySearch(
  ...
  @Override
  public NPUResponsePublicKeySearch convertFromWire(
    final NPU1ResponsePublicKeySearch message)
  {
