...
import com.io7m.northpike.protocol.user.cb.NPU1ResponseAgentLabelSearch;
...
public enum NPUVResponseAgentLabelSearch
  implements NPProtocolMessageValidatorType<NPUResponseAgentLabelSearch, NPU1ResponseAgentLabelSearch>
{
  /**
   * A validator.
   */

  RESPONSE_AGENT_LABEL_SEARCH;

  @Override
  public NPU1ResponseAgentLabelSearch convertToWire(
    final NPUResponseAgentLabelSearch message)
  {
    return new NPU1ResponseAgentLabelSearch(
  ...
  @Override
  public NPUResponseAgentLabelSearch convertFromWire(
    final NPU1ResponseAgentLabelSearch message)
  {
