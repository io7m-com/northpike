...
public final class NPU1Messages
  implements NPProtocolMessagesType<NPUMessageType>, RPServiceType
{
  private static final ProtocolNPU PROTOCOL = new ProtocolNPU();
  ...
  public static final String CONTENT_TYPE =
    "application/northpike_user+cedarbridge";

  private final BSSReaderProviderType readers;
  private final BSSWriterProviderType writers;
  private final NPU1Validation validator;
  private final CBProtocolMessageVersionedSerializerType<ProtocolNPUType> serializer;
    ...
    final BSSWriterProviderType inWriters)
  {
    ...
    this.validator = new NPU1Validation();
    this.serializer =
    ...
    throws NPProtocolException
  {
    ...
    try {
      return this.validator.convertFromWire(
        (ProtocolNPUv1Type) this.serializer.deserialize(context)
      );
