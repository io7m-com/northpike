...
public enum NPUVResponseToolExecutionDescriptionValidate
  ...
  NPU1ResponseToolExecutionDescriptionValidate>
{
  ...
  RESPONSE_TOOL_EXECUTION_DESCRIPTION_VALIDATE;

  @Override
  public NPU1ResponseToolExecutionDescriptionValidate convertToWire(
    final NPUResponseToolExecutionDescriptionValidate message)
  {
    return new NPU1ResponseToolExecutionDescriptionValidate(
  ...
  @Override
  public NPUResponseToolExecutionDescriptionValidate convertFromWire(
    final NPU1ResponseToolExecutionDescriptionValidate message)
  {
