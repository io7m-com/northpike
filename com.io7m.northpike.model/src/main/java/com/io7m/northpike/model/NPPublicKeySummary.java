...
/**
 * A summary of a public key used to verify the signatures on commits.
 *
 * @param userID     The key's first user ID
...
public record NPPublicKeySummary(
  String userID,
  ...
  Optional<OffsetDateTime> timeExpires)
{
  ...
  public NPPublicKeySummary
  {
    Objects.requireNonNull(fingerprint, "fingerprint");
    Objects.requireNonNull(userID, "primaryUserID");
