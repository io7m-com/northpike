...
public final class NPIMessages
  implements NPProtocolMessagesType<NPIMessageType>, RPServiceType
{
  private static final ProtocolNPI PROTOCOL = new ProtocolNPI();
  ...
  private final NPIValidation validator;
  private final CBProtocolMessageVersionedSerializerType<ProtocolNPIType> serializer;
    ...
    final BSSWriterProviderType inWriters)
  {
    ...
    this.validator = new NPIValidation();
    this.serializer =
