...
import com.io7m.northpike.server.internal.users.NPUCmdAuditSearchPrevious;
...
public final class NPUCmdAuditSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAuditSearchPrevious();
    ...
    final var command =
      new NPUCommandAuditSearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.onAuthenticationRequire())
      .thenReturn(userId);
    Mockito.when(this.context.property(NPAuditPagedType.class))
