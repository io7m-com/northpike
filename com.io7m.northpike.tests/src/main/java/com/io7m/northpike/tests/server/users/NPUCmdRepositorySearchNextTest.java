...
import com.io7m.northpike.server.internal.users.NPUCmdRepositorySearchNext;
...
public final class NPUCmdRepositorySearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdRepositorySearchNext();
    ...
    final var command =
      new NPUCommandRepositorySearchNext(
        UUID.randomUUID()
      );
