...
import com.io7m.northpike.server.internal.users.NPUCmdPlanSearchPrevious;
...
public final class NPUCmdPlanSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdPlanSearchPrevious();
    ...
    final var command =
      new NPUCommandPlanSearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.onAuthenticationRequire())
      .thenReturn(userId);
    Mockito.when(this.context.property(NPPlansPagedType.class))
