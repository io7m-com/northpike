...
import com.io7m.northpike.server.internal.users.NPUCmdAgentSearchBegin;
...
public final class NPUCmdAgentSearchBeginTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentSearchBegin();
