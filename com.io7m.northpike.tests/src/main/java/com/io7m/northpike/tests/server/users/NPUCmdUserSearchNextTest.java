...
import com.io7m.northpike.server.internal.users.NPUCmdUserSearchNext;
...
public final class NPUCmdUserSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdUserSearchNext();
