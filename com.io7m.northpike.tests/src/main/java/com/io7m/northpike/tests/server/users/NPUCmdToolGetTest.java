...
import com.io7m.northpike.server.internal.users.NPUCmdToolGet;
...
public final class NPUCmdToolGetTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdToolGet();
    ...
    throws Exception
  {
    ...
    final var factory3 = new NPTMFactory3();
    this.services.register(NPToolFactoryType.class, factory3);
    ...
    assertEquals(factory3.toolDescription(), r.description().orElseThrow());
  }
}
