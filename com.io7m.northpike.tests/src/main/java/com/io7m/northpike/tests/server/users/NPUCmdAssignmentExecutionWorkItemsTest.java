...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentExecutionWorkItems;
...
public final class NPUCmdAssignmentExecutionWorkItemsTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAssignmentExecutionWorkItems();
    ...
    throws Exception
  {
    ...
    assertEquals(workItems, r.results());
  }
}
