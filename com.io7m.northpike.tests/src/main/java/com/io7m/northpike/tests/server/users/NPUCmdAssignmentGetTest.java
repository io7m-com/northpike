...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentGet;
...
public final class NPUCmdAssignmentGetTest
{
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.empty(), r.assignment());
  }
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.of(assignment), r.assignment());
  }
}
