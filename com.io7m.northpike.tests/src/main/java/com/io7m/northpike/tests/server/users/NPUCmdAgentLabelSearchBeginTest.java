...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLabelSearchBegin;
...
public final class NPUCmdAgentLabelSearchBeginTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLabelSearchBegin();
