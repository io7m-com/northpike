...
import com.io7m.northpike.plans.parsers.NPPlanFormats;
import com.io7m.northpike.protocol.user.NPUCommandPlanGet;
import com.io7m.northpike.server.internal.security.NPSecurity;
import com.io7m.northpike.server.internal.security.NPSecurityPolicy;
import com.io7m.northpike.server.internal.users.NPUCmdPlanGet;
...
public final class NPUCmdPlanGetTest
{
  static final NPPlanDescriptionUnparsed PLAN_DESCRIPTION =
    new NPPlanDescriptionUnparsed(
      ...
      """
        ...
        <P:Plan xmlns:P="urn:com.io7m.northpike.plans:1" Name="com.io7m.build" Version="1">
          <P:Timeouts AgentSelection="PT30M" TaskExecution="PT30M"/>
        </P:Plan>
        """
    );
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdPlanGet();
    ...
    final var command =
      new NPUCommandPlanGet(
        UUID.randomUUID(),
        PLAN_DESCRIPTION.identifier()
      );
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.empty(), r.plan());
  }
    ...
    throws Exception
  {
    ...
    Mockito.when(planGet.execute(any()))
      .thenReturn(Optional.of(PLAN_DESCRIPTION));

    final var r = handler.execute(this.context, command);
    assertEquals(r.correlationID(), command.messageID());

    assertEquals(Optional.of(PLAN_DESCRIPTION), r.plan());
  }
}
