...
import com.io7m.northpike.server.internal.users.NPUCmdToolExecutionDescriptionSearchPrevious;
...
public final class NPUCmdToolExecutionDescriptionSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdToolExecutionDescriptionSearchPrevious();
    ...
    final var command =
      new NPUCommandToolExecutionDescriptionSearchPrevious(
        UUID.randomUUID()
      );
