...
import com.io7m.northpike.agent.internal.console.NPACCmdServerGet;
...
public final class NPACCmdServerGetTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPACCmdServerGet();
    ...
    throws Exception
  {
    ...
    final var serverGet =
      Mockito.mock(ServerGetType.class);

    Mockito.when(this.transaction.queries(ServerGetType.class))
      .thenReturn(serverGet);

    Mockito.when(serverGet.execute(server))
