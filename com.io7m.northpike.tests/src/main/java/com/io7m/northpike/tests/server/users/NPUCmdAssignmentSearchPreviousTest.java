...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentSearchPrevious;
...
public final class NPUCmdAssignmentSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAssignmentSearchPrevious();
    ...
    final var command =
      new NPUCommandAssignmentSearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.property(NPAssignmentsPagedType.class))
