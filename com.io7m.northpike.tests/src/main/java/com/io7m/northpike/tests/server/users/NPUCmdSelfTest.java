...
import com.io7m.northpike.server.internal.users.NPUCmdSelf;
...
public final class NPUCmdSelfTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdSelf();
    ...
    final var command =
      new NPUCommandSelf(UUID.randomUUID());
    ...
    throws Exception
  {
    ...
    assertEquals(r.userId(), user.userId());
  }
}
