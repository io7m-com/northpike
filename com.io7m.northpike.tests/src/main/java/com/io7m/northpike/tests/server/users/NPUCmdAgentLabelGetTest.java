...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLabelGet;
...
public final class NPUCmdAgentLabelGetTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLabelGet();
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.empty(), r.agentLabel());
  }
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.of(label), r.agentLabel());
  }
}
