...
import com.io7m.northpike.server.internal.users.NPUCmdPlanSearchNext;
...
public final class NPUCmdPlanSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdPlanSearchNext();
