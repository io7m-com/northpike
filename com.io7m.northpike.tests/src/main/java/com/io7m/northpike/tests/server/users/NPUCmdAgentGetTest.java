...
import com.io7m.northpike.server.internal.users.NPUCmdAgentGet;
...
public final class NPUCmdAgentGetTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentGet();
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.empty(), r.agent());
  }
    ...
    throws Exception
  {
    ...
    assertEquals(Optional.of(agent), r.agent());
  }
}
