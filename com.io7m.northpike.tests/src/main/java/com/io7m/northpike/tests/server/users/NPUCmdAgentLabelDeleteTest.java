...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLabelDelete;
...
public final class NPUCmdAgentLabelDeleteTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLabelDelete();
