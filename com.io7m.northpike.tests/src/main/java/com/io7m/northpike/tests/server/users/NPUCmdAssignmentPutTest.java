...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentPut;
...
public final class NPUCmdAssignmentPutTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAssignmentPut();
    ...
    throws Exception
  {
    ...
    final var user =
      new NPUser(
        UUID.fromString("ab27f114-6b29-5ab2-a528-b41ef98abe76"),
        new IdName("x"),
        new MSubject(Set.of(NPSecRole.ASSIGNMENTS_WRITER.role()))
      );
