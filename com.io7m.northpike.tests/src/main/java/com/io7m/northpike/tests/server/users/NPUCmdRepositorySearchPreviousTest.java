...
import com.io7m.northpike.server.internal.users.NPUCmdRepositorySearchPrevious;
...
public final class NPUCmdRepositorySearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdRepositorySearchPrevious();
    ...
    final var command =
      new NPUCommandRepositorySearchPrevious(
        UUID.randomUUID()
      );
