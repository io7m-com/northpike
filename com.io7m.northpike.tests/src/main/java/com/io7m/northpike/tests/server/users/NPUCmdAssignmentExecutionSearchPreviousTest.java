...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentExecutionSearchPrevious;
...
public final class NPUCmdAssignmentExecutionSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAssignmentExecutionSearchPrevious();
    ...
    final var command =
      new NPUCommandAssignmentExecutionSearchPrevious(
        UUID.randomUUID()
      );
