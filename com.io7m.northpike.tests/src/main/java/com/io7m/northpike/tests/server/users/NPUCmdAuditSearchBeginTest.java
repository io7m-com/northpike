...
import com.io7m.northpike.server.internal.users.NPUCmdAuditSearchBegin;
...
public final class NPUCmdAuditSearchBeginTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAuditSearchBegin();
    ...
    final var command =
      new NPUCommandAuditSearchBegin(
        UUID.randomUUID(),
    ...
    throws Exception
  {
    ...
    final var userId =
      new NPUser(
        UUID.fromString("ab27f114-6b29-5ab2-a528-b41ef98abe76"),
        new IdName("x"),
        new MSubject(Set.of(NPSecRole.AUDIT_LOG_READER.role()))
      );
    ...
    final var list =
      Mockito.mock(NPDatabaseQueriesAuditType.EventSearchType.class);

    Mockito.when(this.transaction.queries(NPDatabaseQueriesAuditType.EventSearchType.class))
      .thenReturn(list);

    final var paged =
      Mockito.mock(NPAuditPagedType.class);
    ...
    Mockito.verify(this.context, new Times(1))
      .setProperty(NPAuditPagedType.class, paged);
    Mockito.verify(this.transaction, new Times(1))
      .queries(NPDatabaseQueriesAuditType.EventSearchType.class);
    Mockito.verify(this.transaction, new Times(1))
      .close();
