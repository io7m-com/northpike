...
import com.io7m.northpike.server.internal.users.NPUCmdUserSearchPrevious;
...
public final class NPUCmdUserSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdUserSearchPrevious();
    ...
    final var command =
      new NPUCommandUserSearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.onAuthenticationRequire())
      .thenReturn(userId);
    Mockito.when(this.context.property(NPUsersPagedType.class))
