...
import com.io7m.northpike.server.internal.users.NPUCmdAgentSearchPrevious;
...
public final class NPUCmdAgentSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentSearchPrevious();
    ...
    final var command =
      new NPUCommandAgentSearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.onAuthenticationRequire())
      .thenReturn(userId);
    Mockito.when(this.context.property(NPAgentPagedType.class))
    ...
    throws Exception
  {
      ...
      new NPPage<>(
        List.of(
          new NPAgentDescription(
            ...
            "Agent 0",
            ed448.generateKeyPair().publicKey(),
            Map.of(),
            Map.of(),
            Map.of()
          ).summary(),
    ...
    final var paged =
      Mockito.mock(NPAgentPagedType.class);
