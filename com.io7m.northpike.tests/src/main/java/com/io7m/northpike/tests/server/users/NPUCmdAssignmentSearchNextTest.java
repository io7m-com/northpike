...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentSearchNext;
...
public final class NPUCmdAssignmentSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAssignmentSearchNext();
    ...
    final var command =
      new NPUCommandAssignmentSearchNext(
        UUID.randomUUID()
      );
