...
import com.io7m.northpike.server.internal.users.NPUCmdAuditSearchNext;
...
public final class NPUCmdAuditSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAuditSearchNext();
