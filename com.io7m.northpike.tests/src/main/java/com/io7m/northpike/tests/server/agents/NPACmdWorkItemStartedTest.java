...
import com.io7m.northpike.server.internal.agents.NPACmdWorkItemStarted;
...
public final class NPACmdWorkItemStartedTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPACmdWorkItemStarted();
    ...
    final var command =
      new NPACommandCWorkItemStarted(
        UUID.randomUUID(),
    ...
    throws Exception
  {
    ...
    final var command =
      new NPACommandCWorkItemStarted(UUID.randomUUID(), identifier);
