...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLabelSearchNext;
...
public final class NPUCmdAgentLabelSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLabelSearchNext();
    ...
    final var command =
      new NPUCommandAgentLabelSearchNext(
        UUID.randomUUID()
      );
