...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLoginChallengeSearchNext;
...
public final class NPUCmdAgentLoginChallengeSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLoginChallengeSearchNext();
    ...
    final var command =
      new NPUCommandAgentLoginChallengeSearchNext(
        UUID.randomUUID()
      );
