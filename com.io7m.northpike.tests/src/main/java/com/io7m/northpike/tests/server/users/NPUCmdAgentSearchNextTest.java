...
import com.io7m.northpike.server.internal.users.NPUCmdAgentSearchNext;
...
public final class NPUCmdAgentSearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentSearchNext();
