...
import com.io7m.northpike.server.internal.users.NPUCmdAssignmentExecutionSearchBegin;
...
public final class NPUCmdAssignmentExecutionSearchBeginTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAssignmentExecutionSearchBegin();
