...
import com.io7m.northpike.server.internal.agents.NPACmdWorkItemSucceeded;
...
public final class NPACmdWorkItemSucceededTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPACmdWorkItemSucceeded();
    ...
    final var command =
      new NPACommandCWorkItemSucceeded(
        UUID.randomUUID(),
    ...
    throws Exception
  {
    ...
    final var command =
      new NPACommandCWorkItemSucceeded(UUID.randomUUID(), identifier);
