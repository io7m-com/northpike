...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLoginChallengeSearchPrevious;
...
public final class NPUCmdAgentLoginChallengeSearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLoginChallengeSearchPrevious();
    ...
    final var command =
      new NPUCommandAgentLoginChallengeSearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.property(NPAgentLoginChallengePagedType.class))
