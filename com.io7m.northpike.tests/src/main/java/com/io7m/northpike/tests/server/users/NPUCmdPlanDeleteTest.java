...
import com.io7m.northpike.server.internal.users.NPUCmdPlanDelete;
...
public final class NPUCmdPlanDeleteTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdPlanDelete();
    ...
    final var command =
      new NPUCommandPlanDelete(
        UUID.randomUUID(),
        Set.of(NPPlanIdentifier.of("x", 1L))
      );
