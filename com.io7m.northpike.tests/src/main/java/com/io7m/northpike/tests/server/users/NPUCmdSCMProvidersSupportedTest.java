...
import com.io7m.northpike.server.internal.users.NPUCmdSCMProvidersSupported;
...
public final class NPUCmdSCMProvidersSupportedTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdSCMProvidersSupported();
    ...
    final var command =
      new NPUCommandSCMProvidersSupported(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    this.services.register(
      NPSCMRepositoryFactoryType.class,
      new NPSCMRepositoriesJGit()
    );

    final var r = handler.execute(this.context, command);
    assertEquals(r.correlationID(), command.messageID());
    assertEquals(Set.of(NPSCMRepositoriesJGit.providerGet()), r.providers());
  }
}
