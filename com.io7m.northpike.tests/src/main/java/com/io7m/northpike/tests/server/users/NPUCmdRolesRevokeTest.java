...
import com.io7m.northpike.server.internal.users.NPUCmdRolesRevoke;
...
public final class NPUCmdRolesRevokeTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdRolesRevoke();
    ...
    throws Exception
  {
    ...
    assertEquals("ERROR_OPERATION_NOT_PERMITTED", ex.message());
    ...
    throws Exception
  {
    ...
    Mockito.verify(this.transaction, new Times(1))
      .setOwner(new NPAuditOwnerType.User(user0.userId()));
    Mockito.verify(this.transaction, new Times(1))
      .commit();
  }
}
