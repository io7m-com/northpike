...
import com.io7m.northpike.server.internal.users.NPUCmdPublicKeySearchNext;
...
public final class NPUCmdPublicKeySearchNextTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdPublicKeySearchNext();
    ...
    final var command =
      new NPUCommandPublicKeySearchNext(
        UUID.randomUUID()
      );
