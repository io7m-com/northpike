...
import com.io7m.northpike.server.internal.users.NPUCmdDisconnect;
...
public final class NPUCmdDisconnectTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdDisconnect();
    ...
    final var command =
      new NPUCommandDisconnect(UUID.randomUUID());
