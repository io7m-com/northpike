...
import com.io7m.northpike.server.internal.users.NPUCmdAgentLoginChallengeDelete;
...
public final class NPUCmdAgentLoginChallengeDeleteTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdAgentLoginChallengeDelete();
    ...
    final var command =
      new NPUCommandAgentLoginChallengeDelete(
        UUID.randomUUID(),
    ...
    throws Exception
  {
    ...
    final var user =
      new NPUser(
        UUID.fromString("ab27f114-6b29-5ab2-a528-b41ef98abe76"),
        new IdName("x"),
        new MSubject(Set.of(NPSecRole.AGENT_LOGIN_CHALLENGE_WRITER.role()))
      );
