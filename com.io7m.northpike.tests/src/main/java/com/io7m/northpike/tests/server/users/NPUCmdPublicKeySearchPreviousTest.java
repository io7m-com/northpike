...
import com.io7m.northpike.server.internal.users.NPUCmdPublicKeySearchPrevious;
...
public final class NPUCmdPublicKeySearchPreviousTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdPublicKeySearchPrevious();
    ...
    final var command =
      new NPUCommandPublicKeySearchPrevious(
        UUID.randomUUID()
      );
    ...
    throws Exception
  {
    ...
    Mockito.when(this.context.onAuthenticationRequire())
      .thenReturn(userId);
    Mockito.when(this.context.property(NPPublicKeysPagedType.class))
