...
import com.io7m.northpike.server.internal.users.NPUCmdRepositoryPublicKeysAssigned;
...
public final class NPUCmdRepositoryPublicKeysAssignedTest
{
  ...
  public void testFailure0()
    throws Exception
  {
    final var handler = new NPUCmdRepositoryPublicKeysAssigned();
    ...
    throws Exception
  {
    ...
    Mockito.when(keyAssign.execute(any()))
      .thenReturn(Set.of(
        new NPFingerprint("f572d396fae9206628714fb2ce00f72e94f2258a"),
        new NPFingerprint("f572d396fae9206628714fb2ce00f72e94f2258b"),
        new NPFingerprint("f572d396fae9206628714fb2ce00f72e94f2258c")
      ));
