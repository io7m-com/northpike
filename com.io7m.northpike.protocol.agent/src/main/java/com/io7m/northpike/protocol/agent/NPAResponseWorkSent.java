...
/**
 * A response to the sending of work.
 *
 * @param messageID     The message ID
 * @param correlationID The command that prompted this response
 * @param workItem      The work item
 * @param acceptedWork  {@code true} if the agent has accepted the work
 */

public record NPAResponseWorkSent(
  UUID messageID,
  UUID correlationID,
  NPWorkItemIdentifier workItem,
  boolean acceptedWork)
