 ...
 * @param challenge     A challenge value that must be signed by the agent
 */

public record NPAResponseLoginChallenge(
  UUID messageID,
  UUID correlationID,
  ...
  implements NPAResponseType
{
  ...
  public NPAResponseLoginChallenge
  {
  ...
  public static NPAResponseLoginChallenge createCorrelated(
