...
public final class NPTLS1
{
  ...
  /**
   * @return A parser for the configuration elements
   */

  public static BTElementHandlerConstructorType<?, NPTLSConfigurationType> configuration()
  {
    return Blackthorne.forOneOf(configurationElements());
  }

  /**
   * @return Parsers for the configuration elements
   */
    ...
    return Map.ofEntries(
      Map.entry(
        ...
        Blackthorne.forScalarAttribute(
          element("TLSDisabled"),
          (context, attributes) -> NPTLSDisabled.TLS_DISABLED
        )
      ),
      Map.entry(
        element("TLSEnabled"),
    ...
    final String localName)
  {
    return BTQualifiedName.of(
      NPTLSSchemas.schema1().namespace().toString(),
      localName
    );
  }
}
