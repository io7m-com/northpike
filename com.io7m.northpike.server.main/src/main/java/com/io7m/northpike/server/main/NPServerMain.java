...
package com.io7m.northpike.server.main;

import com.io7m.northpike.server.main.internal.NPACmdRun;
import com.io7m.northpike.server.main.internal.NPACmdSelfCheck;
import com.io7m.northpike.server.main.internal.NPACmdSetAdmin;
...
public final class NPServerMain implements Runnable
{
  private static final Logger LOG =
    LoggerFactory.getLogger(NPServerMain.class);
    ...
    final String[] inArgs)
  {
    ...
    final var metadata =
      new QApplicationMetadata(
        "northpike-server",
        "com.io7m.northpike.server",
        NPServerVersion.MAIN_VERSION,
        NPServerVersion.MAIN_BUILD,
        "The northpike server.",
    ...
    builder.addCommand(new NPACmdSetAdmin());
    builder.addCommand(new NPACmdSelfCheck());
  ...
  public static int mainExitless(
    final String[] args)
  {
    final NPServerMain cm = new NPServerMain(args);
    cm.run();
    return cm.exitCode();
  }
