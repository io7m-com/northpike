...
public interface NPAgentDatabaseTransactionType extends AutoCloseable
{
  @Override
  void close()
   ...
   * @return Queries
   *
   * @throws NPAgentDatabaseException On errors
   */

  <T extends NPAgentDatabaseQueriesType> T queries(Class<T> queryClass)
    throws NPAgentDatabaseException;
