...
public final class NPAShellCmdAgentGet
  extends NPAShellCmdAbstractCR<NPACCommandAgentGet, NPACResponseAgent>
{
    ...
    final RPServiceDirectoryType inServices)
  {
    super(
      ...
      new QCommandMetadata(
        "agent-get",
        new QConstant("Get an existing agent."),
        Optional.empty()
      ),
  ...
  @Override
  protected NPACCommandAgentGet onCreateCommand(
  ...
  protected void onFormatResponse(
    final QCommandContextType context,
    final NPACResponseAgent response)
    throws Exception
  {
