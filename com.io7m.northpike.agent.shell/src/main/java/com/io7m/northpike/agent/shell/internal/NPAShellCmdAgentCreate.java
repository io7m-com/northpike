...
public final class NPAShellCmdAgentCreate
  extends NPAShellCmdAbstractCR<NPACCommandAgentCreate, NPACResponseOK>
{
    ...
    final RPServiceDirectoryType inServices)
  {
    super(
      ...
      new QCommandMetadata(
        "agent-create",
        new QConstant("Create a new agent."),
        Optional.empty()
      ),
  ...
  @Override
  protected NPACCommandAgentCreate onCreateCommand(
