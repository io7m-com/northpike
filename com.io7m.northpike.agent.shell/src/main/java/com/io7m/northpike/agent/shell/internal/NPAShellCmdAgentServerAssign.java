...
public final class NPAShellCmdAgentServerAssign
  extends NPAShellCmdAbstractCR<NPACCommandAgentServerAssign, NPACResponseOK>
{
  ...
  public NPAShellCmdAgentServerAssign(
    final RPServiceDirectoryType inServices)
  {
    super(
      ...
      new QCommandMetadata(
        "agent-server-assign",
        new QConstant("Assign a server to an agent."),
        Optional.empty()
      ),
    ...
    final QCommandContextType context)
  {
    return new NPACCommandAgentServerAssign(
      ...
      Optional.of(context.parameterValue(SERVER))
    );
  }
