...
public final class NPAShellCmdLogin extends NPAShellCmdAbstractC
{
  ...
  private static final QParameterNamed1<String> ACCESS_KEY =
    new QParameterNamed1<>(
      "--access-key",
      List.of(),
      new QConstant(
    ...
    throws Exception
  {
    ...
    final var accessKey =
      context.parameterValue(ACCESS_KEY);
