...
/**
 * "repository-search-begin"
 */

public final class NPShellCmdRepositorySearchBegin
  extends NPShellCmdAbstractCR<NPUCommandRepositorySearchBegin, NPUResponseRepositorySearch>
{
  ...
  public NPShellCmdRepositorySearchBegin(
    final RPServiceDirectoryType inServices)
  {
    super(
      ...
      new QCommandMetadata(
        "repository-search-begin",
        new QConstant("Begin searching for repositories."),
        Optional.empty()
      ),
  ...
  @Override
  protected NPUCommandRepositorySearchBegin onCreateCommand(
    final QCommandContextType context)
  {
    ...
    return new NPUCommandRepositorySearchBegin(UUID.randomUUID(), parameters);
  }
