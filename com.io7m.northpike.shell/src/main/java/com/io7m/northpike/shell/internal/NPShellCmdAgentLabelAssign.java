...
public final class NPShellCmdAgentLabelAssign extends NPShellCmdAbstractU
{
  ...
  public NPShellCmdAgentLabelAssign(
    final RPServiceDirectoryType inServices)
  {
    super(
      ...
      new QCommandMetadata(
        "agent-label-assign",
        new QConstant("Assign labels to an agent."),
        Optional.empty()
      )
    );
  }
    ...
    throws Exception
  {
    ...
    for (final var label : context.parameterValues(LABEL_NAME)) {
      existingLabels.put(label, new NPAgentLabel(label, ""));
    }
