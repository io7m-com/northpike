...
public final class NPShellCmdAuditSearchNext
  extends NPShellCmdAbstractCR<NPUCommandAuditSearchNext, NPUResponseAuditSearch>
{
  /**
   * Construct a command.
   *
  ...
  public NPShellCmdAuditSearchNext(
  ...
  @Override
  protected NPUCommandAuditSearchNext onCreateCommand(
    final QCommandContextType context)
  {
    return new NPUCommandAuditSearchNext(UUID.randomUUID());
  }
