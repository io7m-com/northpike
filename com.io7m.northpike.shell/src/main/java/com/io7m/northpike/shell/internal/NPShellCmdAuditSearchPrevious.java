...
public final class NPShellCmdAuditSearchPrevious
  extends NPShellCmdAbstractCR<NPUCommandAuditSearchPrevious, NPUResponseAuditSearch>
{
  /**
   * Construct a command.
   *
  ...
  public NPShellCmdAuditSearchPrevious(
  ...
  @Override
  protected NPUCommandAuditSearchPrevious onCreateCommand(
    final QCommandContextType context)
  {
    return new NPUCommandAuditSearchPrevious(UUID.randomUUID());
  }
