...
package com.io7m.northpike.agent.workexec.main;
...
import static com.io7m.northpike.agent.workexec.main.internal.NPWELogging.configureLoggingInitial;

/**
 * The main entry point.
 */

public final class NPWorkExecMain implements Runnable
{
  private static final Logger LOG =
    LoggerFactory.getLogger(NPWorkExecMain.class);
    ...
    final String[] inArgs)
  {
    ...
    final var metadata =
      new QApplicationMetadata(
        "northpike-workexec",
        "com.io7m.northpike.agent.workexec",
        NPWorkExecVersion.MAIN_VERSION,
        NPWorkExecVersion.MAIN_BUILD,
        "The northpike command-line work executor.",
  ...
  public static int mainExitless(
    final String[] args)
  {
    configureLoggingInitial();

    final NPWorkExecMain cm = new NPWorkExecMain(args);
    cm.run();
    return cm.exitCode();
  }
