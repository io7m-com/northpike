...
package com.io7m.northpike.toolexec.lines;
...
import com.io7m.northpike.toolexec.lines.internal.NPTLines;
import com.io7m.northpike.toolexec.program.api.NPTPVariableType;

import java.util.List;

/**
 * A toolexec constant lines provider.
 */

public final class NPTLinesLanguageProvider
  implements NPTEvaluationLanguageProviderType
{
  private static final NPFormatName FORMAT_NAME =
    NPFormatName.of("com.io7m.northpike.toolexec.lines");

  /**
   * A toolexec constant lines provider.
   */

  public NPTLinesLanguageProvider()
  {
  ...
  {
    return new NPTLines(program);
  }

  @Override
  public String description()
  {
    return "Constant lines language provider.";
  }
}
