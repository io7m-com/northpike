...
/**
 * Continuous integration (Tool execution constant lines language provider)
 */

module com.io7m.northpike.toolexec.lines
{
  ...
  provides NPTEvaluationLanguageProviderType
    with NPTLinesLanguageProvider;

  exports com.io7m.northpike.toolexec.lines;
}
