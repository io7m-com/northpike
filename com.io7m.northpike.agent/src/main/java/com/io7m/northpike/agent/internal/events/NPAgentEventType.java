...
/**
 * The type of agent events.
 */

@NPDocumentation("The type of agent events.")
public sealed interface NPAgentEventType
  ...
  NPAgentWorkerConnectionStopped,
  NPAgentWorkerExecutorStarted,
  NPAgentWorkerExecutorStopped,
  NPAgentWorkerStarted,
  NPAgentWorkerStopped
{
  @Override
