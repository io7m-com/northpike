...
/**
 * A server was assigned to an agent.
 *
 * @param agentName The agent name
 * @param serverID The server ID
 */

@NPDocumentation("A server was assigned to an agent.")
public record NPAgentServerAssigned(
  ...
  implements NPAgentEventType
{
  ...
  public String name()
  {
    return "AgentServerAssigned";
  }

  @Override
  public String message()
  {
    return "Agent server assigned";
  }
