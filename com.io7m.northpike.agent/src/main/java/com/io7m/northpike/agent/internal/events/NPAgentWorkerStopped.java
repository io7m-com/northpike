...
/**
 * An agent worker was stopped.
 *
 * @param agentName The agent name
 */

@NPDocumentation("An agent worker was stopped.")
public record NPAgentWorkerStopped(
  ...
  implements NPAgentEventType
{
  ...
  public String name()
  {
    return "AgentWorkerStopped";
  }

  @Override
  public String message()
  {
    return "Agent worker stopped";
  }
