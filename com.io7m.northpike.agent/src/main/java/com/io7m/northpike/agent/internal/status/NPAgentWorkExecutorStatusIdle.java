...
import static com.io7m.northpike.strings.NPStringConstants.AGENT_STATUS_WORKEXEC_READY;

/**
 * The work executor is idle.
 */

public record NPAgentWorkExecutorStatusIdle()
  implements NPAgentWorkExecutorStatusType
{
  ...
  {
    return strings.format(AGENT_STATUS_WORKEXEC_READY);
  }
