...
/**
 * An agent worker connection was started.
 *
 * @param agentName The agent name
 */

@NPDocumentation("An agent worker connection was started.")
public record NPAgentWorkerConnectionStarted(
  ...
  implements NPAgentEventType
{
  ...
  public NPAgentWorkerConnectionStarted
  {
  ...
  public String name()
  {
    return "AgentWorkerConnectionStarted";
  }

  @Override
  public String message()
  {
    return "Agent worker connection started";
  }
