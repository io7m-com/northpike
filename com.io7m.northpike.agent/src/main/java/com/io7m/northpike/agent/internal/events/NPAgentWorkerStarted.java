...
/**
 * An agent worker was started.
 *
 * @param agentName The agent name
 */

@NPDocumentation("An agent worker was started.")
public record NPAgentWorkerStarted(
  ...
  implements NPAgentEventType
{
  ...
  public String name()
  {
    return "AgentWorkerStarted";
  }

  @Override
  public String message()
  {
    return "Agent worker started";
  }
