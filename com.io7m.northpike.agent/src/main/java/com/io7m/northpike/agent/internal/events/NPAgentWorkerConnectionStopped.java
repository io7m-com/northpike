...
/**
 * An agent worker connection was stopped.
 *
 * @param agentName The agent name
 */

@NPDocumentation("An agent worker connection was stopped.")
public record NPAgentWorkerConnectionStopped(
  ...
  implements NPAgentEventType
{
  ...
  public NPAgentWorkerConnectionStopped
  {
  ...
  public String name()
  {
    return "AgentWorkerConnectionStopped";
  }

  @Override
  public String message()
  {
    return "Agent worker connection stopped";
  }
