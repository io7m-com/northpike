...
/**
 * An agent worker controller was started.
 *
 * @param agentName The agent name
 */

@NPDocumentation("An agent worker executor was started.")
public record NPAgentWorkerExecutorStarted(
  NPAgentLocalName agentName)
  implements NPAgentEventType
{
  /**
   * An agent worker executor was started.
   *
   * @param agentName The agent name
   */

  public NPAgentWorkerExecutorStarted
  {
  ...
  public String name()
  {
    return "AgentWorkerExecutorStarted";
  }

  @Override
  public String message()
  {
    return "Agent worker executor started";
  }
