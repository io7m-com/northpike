...
/**
 * An agent worker executor was stopped.
 *
 * @param agentName The agent name
 */

@NPDocumentation("An agent worker executor was stopped.")
public record NPAgentWorkerExecutorStopped(
  ...
  implements NPAgentEventType
{
  ...
  public NPAgentWorkerExecutorStopped
  {
  ...
  public String name()
  {
    return "AgentWorkerExecutorStopped";
  }

  @Override
  public String message()
  {
    return "Agent worker executor stopped";
  }
