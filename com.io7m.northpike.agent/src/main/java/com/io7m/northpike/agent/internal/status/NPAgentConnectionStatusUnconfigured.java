...
import static com.io7m.northpike.strings.NPStringConstants.AGENT_STATUS_CONNECTION_UNCONFIGURED;

/**
 * The server connection is not configured.
 */

public record NPAgentConnectionStatusUnconfigured()
  implements NPAgentConnectionStatusType
{
  ...
  {
    return strings.format(AGENT_STATUS_CONNECTION_UNCONFIGURED);
  }
