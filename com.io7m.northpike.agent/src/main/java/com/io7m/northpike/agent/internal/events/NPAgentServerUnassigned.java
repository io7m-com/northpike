...
/**
 * A server was unassigned from an agent.
 *
 * @param agentName The agent name
 */

@NPDocumentation("A server was unassigned from an agent.")
public record NPAgentServerUnassigned(
  ...
  implements NPAgentEventType
{
  ...
  public NPAgentServerUnassigned
  {
  ...
  public String name()
  {
    return "AgentServerUnassigned";
  }

  @Override
  public String message()
  {
    return "Agent server unassigned";
  }
