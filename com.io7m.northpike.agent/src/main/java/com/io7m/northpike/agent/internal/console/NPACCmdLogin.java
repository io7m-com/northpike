...
/**
 * @see NPACCommandLogin
 */

public final class NPACCmdLogin
  extends NPACCmdAbstract<NPACResponseOK, NPACCommandLogin>
{
  /**
   * @see NPACCommandLogin
   */
  ...
  public NPACCmdLogin()
  {
    super(NPACCommandLogin.class);
  }

  @Override
  public NPACResponseOK execute(
    final NPACCommandContextType context,
    final NPACCommandLogin command)
    throws NPException
  {
    context.checkAccessKey(command.accessKey());
