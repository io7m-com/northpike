...
/**
 * An event produced during the execution of a work.
 *
  ...
  Optional<NPStoredException> exception)
{
  ...
  {
    /**
     * The event contains info-level data.
     */

    INFO,

    /**
     * The event contains warning-level data.
     */

    WARNING,

    /**
     * The event contains error-level data.
     */
