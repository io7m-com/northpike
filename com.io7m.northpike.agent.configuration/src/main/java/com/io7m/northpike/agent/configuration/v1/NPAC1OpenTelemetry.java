...
public final class NPAC1OpenTelemetry
  implements BTElementHandlerType<Object, NPTelemetryConfiguration>
{
    ...
    final BTElementParsingContextType context)
  {
    return Map.ofEntries(
      entry(element("Logs"), NPAC1Logs::new),
      entry(element("Metrics"), NPAC1Metrics::new),
      entry(element("Traces"), NPAC1Traces::new)
    );
  }
