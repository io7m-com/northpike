...
public final class NPAgentConfigurationSchemas
{
  private static final JXESchemaDefinition SCHEMA_1 =
    JXESchemaDefinition.builder()
      .setFileIdentifier("agent-configuration-1.xsd")
      .setLocation(NPAgentConfigurationSchemas.class.getResource(
        "/com/io7m/northpike/agent/configuration/agent-configuration-1.xsd"))
      .setNamespace(URI.create("urn:com.io7m.northpike.agent.configuration:1"))
      .build();
  ...
  private NPAgentConfigurationSchemas()
  {
