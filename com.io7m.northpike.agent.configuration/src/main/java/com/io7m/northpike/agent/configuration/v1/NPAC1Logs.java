...
/**
 * A parser for {@link NPLogs}
 */

public final class NPAC1Logs
  implements BTElementHandlerType<Object, NPLogs>
{
  private NPLogs result;
  ...
  @Override
  public NPLogs onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
