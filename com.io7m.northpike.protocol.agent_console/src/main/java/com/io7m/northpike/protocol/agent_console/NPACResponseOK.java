  ...
  implements NPACResponseType
{
  ...
  public static NPACResponseOK createCorrelated(
    final NPACCommandType<?> command)
  {
    return new NPACResponseOK(UUID.randomUUID(), command.messageID());
  }
}
