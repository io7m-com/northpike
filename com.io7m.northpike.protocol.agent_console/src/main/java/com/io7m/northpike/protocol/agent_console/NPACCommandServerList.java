 ...
 * @param offset    The starting offset server ID
 * @param limit     The number of servers to return
 */

public record NPACCommandServerList(
  UUID messageID,
  Optional<NPAgentServerID> offset,
  long limit)
  implements NPACCommandType<NPACResponseServerList>
{
  /**
   * List servers.
   *
  ...
  @Override
  public Class<NPACResponseServerList> responseClass()
  {
    return NPACResponseServerList.class;
  }
}
