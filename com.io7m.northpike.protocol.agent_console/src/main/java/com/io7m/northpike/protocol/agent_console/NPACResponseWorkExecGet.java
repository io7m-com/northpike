...
/**
 * Get the full description of a supported work executor.
 *
...
public record NPACResponseWorkExecGet(
  UUID messageID,
  UUID correlationID,
  Optional<NPAWorkExecutorSummary> result)
  implements NPACResponseType
{
  ...
  public NPACResponseWorkExecGet
  {
