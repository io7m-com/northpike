 ...
 * @param accessKey The console access key
 */

public record NPACCommandLogin(
  UUID messageID,
  String accessKey)
  implements NPACCommandType<NPACResponseOK>
{
   ...
   *
   * @param messageID The ID of this message
   * @param accessKey The agent public key
   */

  public NPACCommandLogin
  {
  ...
  public static NPACCommandLogin of(
    final String accessKey)
  {
    return new NPACCommandLogin(UUID.randomUUID(), accessKey);
  }
