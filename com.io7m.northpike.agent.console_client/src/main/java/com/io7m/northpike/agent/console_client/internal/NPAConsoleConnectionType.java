...
/**
 * The type of channels from the agent console client to the server.
 */

public interface NPAConsoleConnectionType
  extends NPMessageConnectionType<NPACMessageType, NPACResponseType>
{
