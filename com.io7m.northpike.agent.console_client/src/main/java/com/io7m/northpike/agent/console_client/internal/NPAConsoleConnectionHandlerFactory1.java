...
public final class NPAConsoleConnectionHandlerFactory1
  implements NPAConsoleConnectionHandlerFactoryType
{
  /**
   * The factory of version 1 protocol handlers.
   */

  public NPAConsoleConnectionHandlerFactory1()
  {
  ...
  public GenProtocolIdentifier supported()
  {
    return new GenProtocolIdentifier(
      NPACMessages.protocolId().toString(),
      new GenProtocolVersion(ONE, ZERO)
    );
  }

  @Override
  public NPAConsoleConnectionHandlerType createHandler(
    final NPAConsoleClientConfiguration configuration,
    final Socket socket,
    final InputStream inputStream,
    final OutputStream outputStream)
  {
    return new NPAConsoleConnectionHandler1(
      configuration,
      socket,
      inputStream,
      outputStream
