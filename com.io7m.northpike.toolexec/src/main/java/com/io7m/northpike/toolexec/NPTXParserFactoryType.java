...
/**
 * The type of tool execution parser factories.
 */

public interface NPTXParserFactoryType
  extends ParserFactoryType<NPPreserveLexical, NPTXDescription, NPTXParserType>,
  RPServiceType
{
  /**
