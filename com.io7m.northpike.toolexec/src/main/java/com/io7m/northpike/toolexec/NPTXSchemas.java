...
public final class NPTXSchemas
{
  private static final JXESchemaDefinition SCHEMA_1 =
    JXESchemaDefinition.builder()
      .setFileIdentifier("toolexec-1.xsd")
      .setLocation(NPTXSchemas.class.getResource(
        "/com/io7m/northpike/toolexec/toolexec-1.xsd"))
      .setNamespace(URI.create("urn:com.io7m.northpike.toolexec:1"))
      .build();
