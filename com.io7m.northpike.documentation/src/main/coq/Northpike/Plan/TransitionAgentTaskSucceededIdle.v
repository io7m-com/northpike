...
<: Transition.S P Maps State.
  ...
  Lemma agentSucceededDec : forall s e a,
    {ASSucceeded e = agentStatusOf s a}+{~ASSucceeded e = agentStatusOf s a}.
  Proof.
    move => s e a.
  ...
  (** The "agent went idle" precondition. This state transition can
      ...
      - The status of the agent is _ASSucceeded e_.
  ...
  *)
  ...
  : Prop :=
       P.elementIsTask e
    /\ ASSucceeded e = agentStatusOf s a.
  ...
  Proof.
    ...
    elim (P.elementIs e).
    - move => Ht.
      elim (agentSucceededDec s e a) => [Hacc|Hneq].
      * left; intuition.
      * right; intuition.
    - move => Hb.
      right.
