...
/**
 * A work item was accepted by an agent.
 *
...
public record NPAgentWorkItemAccepted(
  ...
  implements NPAgentWorkItemEventType
{
  @Override
  ...
  public String name()
  {
    return "AgentWorkItemAccepted";
  }

  @Override
  public String message()
  {
    return "WorkItemAccepted";
  }
  ...
  public Map<String, String> asAttributes()
  {
    return Map.ofEntries(
      Map.entry("Agent", this.agentID.toString()),
      Map.entry("WorkItem", this.identifier.toString())
    );
  }
}
