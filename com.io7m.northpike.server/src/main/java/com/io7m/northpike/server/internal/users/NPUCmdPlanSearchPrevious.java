...
/**
 * @see NPUCommandPlanSearchPrevious
 */

public final class NPUCmdPlanSearchPrevious
  extends NPUCmdAbstract<NPUResponsePlanSearch, NPUCommandPlanSearchPrevious>
{
  /**
   * @see NPUCommandPlanSearchPrevious
   */

  public NPUCmdPlanSearchPrevious()
  {
    super(NPUCommandPlanSearchPrevious.class);
  }

  @Override
  public NPUResponsePlanSearch execute(
    final NPUserCommandContextType context,
    final NPUCommandPlanSearchPrevious command)
    throws NPException
  {
    ...
    try (var transaction = context.transaction(NORTHPIKE_READ_ONLY)) {
      final var paged =
        context.property(NPPlansPagedType.class)
          .orElseThrow(() -> {
