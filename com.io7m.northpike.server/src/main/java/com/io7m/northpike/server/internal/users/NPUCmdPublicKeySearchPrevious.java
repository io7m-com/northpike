...
/**
 * @see NPUCommandPublicKeySearchPrevious
 */

public final class NPUCmdPublicKeySearchPrevious
  extends NPUCmdAbstract<NPUResponsePublicKeySearch, NPUCommandPublicKeySearchPrevious>
{
  /**
   * @see NPUCommandPublicKeySearchPrevious
   */

  public NPUCmdPublicKeySearchPrevious()
  {
    super(NPUCommandPublicKeySearchPrevious.class);
  }

  @Override
  public NPUResponsePublicKeySearch execute(
    final NPUserCommandContextType context,
    final NPUCommandPublicKeySearchPrevious command)
    throws NPException
  {
    ...
    try (var connection = context.databaseConnection()) {
      try (var transaction = connection.openTransaction()) {
        final var paged =
          context.property(NPPublicKeysPagedType.class)
            .orElseThrow(() -> {
        ...
        return new NPUResponsePublicKeySearch(
          UUID.randomUUID(),
          command.messageID(),
          paged.pagePrevious(transaction).map(NPPublicKey::encodedForm)
        );
      }
    }
  }
