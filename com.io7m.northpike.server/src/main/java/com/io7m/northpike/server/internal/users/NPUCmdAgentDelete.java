...
/**
 * @see NPUCommandAgentDelete
 */

public final class NPUCmdAgentDelete
  extends NPUCmdAbstract<NPUResponseOK, NPUCommandAgentDelete>
{
  /**
   * @see NPUCommandAgentDelete
   */

  public NPUCmdAgentDelete()
  {
    super(NPUCommandAgentDelete.class);
  }

  @Override
  public NPUResponseOK execute(
    final NPUserCommandContextType context,
    final NPUCommandAgentDelete command)
    throws NPException
  {
