...
public final class NPUserServerConnectionHandlers
{
  ...
  private NPUserServerConnectionHandlers()
  {
  ...
  public static NPUserServerConnectionHandlerType open(
    ...
    throws NPException, IOException
  {
    ...
    if (r0 instanceof final NPIProtocol proto) {
      if (Objects.equals(proto, NPU_1)) {
        ...
        return new NPUserServerConnectionHandler1(
