...
/**
 * @see NPUCommandToolSearchPrevious
 */

public final class NPUCmdToolSearchPrevious
  ...
  NPUCommandToolSearchPrevious>
{
  ...
  public NPUCmdToolSearchPrevious()
  {
    super(NPUCommandToolSearchPrevious.class);
  }

  @Override
  public NPUResponseToolSearch execute(
    final NPUserCommandContextType context,
    final NPUCommandToolSearchPrevious command)
    throws NPException
  {
    ...
    return new NPUResponseToolSearch(
      ...
      new NPPage<>(
        toolPage,
        (int) pagedPrevious.pageIndex(),
        (int) pagedPrevious.pageCount(),
        pagedPrevious.itemOffset()
      )
    );
  }
}
