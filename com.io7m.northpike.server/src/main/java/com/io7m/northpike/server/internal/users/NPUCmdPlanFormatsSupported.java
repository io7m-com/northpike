...
/**
 * @see NPUCommandPlanFormatsSupported
 */

public final class NPUCmdPlanFormatsSupported
  extends NPUCmdAbstract<NPUResponsePlanFormatsSupported, NPUCommandPlanFormatsSupported>
{
  /**
   * @see NPUCommandPlanFormatsSupported
   */

  public NPUCmdPlanFormatsSupported()
  {
    super(NPUCommandPlanFormatsSupported.class);
  }

  @Override
  public NPUResponsePlanFormatsSupported execute(
    final NPUserCommandContextType context,
    final NPUCommandPlanFormatsSupported command)
    throws NPException
  {
