...
/**
 * The type of connections to the server from agents.
 */

public interface NPUserServerConnectionType
  extends NPMessageConnectionType<NPUMessageType, NPUResponseType>
{
  /**
