...
public final class NPAgentServerConnectionHandlers
{
  ...
  private NPAgentServerConnectionHandlers()
  {
  ...
  public static NPAgentServerConnectionHandlerType open(
    ...
    throws NPException, IOException
  {
    ...
    final var r0 =
      NPI_MESSAGES.readLengthPrefixed(strings, sizeLimit, input);

    if (r0 instanceof final NPIProtocol proto) {
      if (Objects.equals(proto, NPA_1)) {
        NPI_MESSAGES.writeLengthPrefixed(output, NPA_1);
        return new NPAgentServerConnectionHandler1(
          sizeLimit, strings, socket, input, output);
      }
      ...
      NPI_MESSAGES.writeLengthPrefixed(
        ...
        new NPIError(
          ...
          strings.format(NPStringConstants.ERROR_PROTOCOL_UNSUPPORTED)
        )
      );
    ...
    NPI_MESSAGES.writeLengthPrefixed(
      ...
      new NPIError(
        errorProtocol(),
        strings.format(NPStringConstants.ERROR_PROTOCOL)
      )
    );
