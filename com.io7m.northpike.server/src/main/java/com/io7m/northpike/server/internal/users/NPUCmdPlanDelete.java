...
/**
 * @see NPUCommandPlanDelete
 */

public final class NPUCmdPlanDelete
  extends NPUCmdAbstract<NPUResponseOK, NPUCommandPlanDelete>
{
  /**
   * @see NPUCommandPlanDelete
   */

  public NPUCmdPlanDelete()
  {
    super(NPUCommandPlanDelete.class);
  }

  @Override
  public NPUResponseOK execute(
    final NPUserCommandContextType context,
    final NPUCommandPlanDelete command)
    throws NPException
  {
    ...
    try (var transaction = context.transaction()) {
      ...
      for (final var id : command.plans()) {
        transaction.queries(NPDatabaseQueriesPlansType.PlanDeleteType.class)
          .execute(id);
      }
