...
/**
 * @see NPUCommandAssignmentExecutionSearchNext
 */

public final class NPUCmdAssignmentExecutionSearchNext
  extends NPUCmdAbstract<
  NPUResponseAssignmentExecutionSearch, NPUCommandAssignmentExecutionSearchNext>
{
  /**
   * @see NPUCommandAssignmentExecutionSearchNext
   */

  public NPUCmdAssignmentExecutionSearchNext()
  {
    super(NPUCommandAssignmentExecutionSearchNext.class);
  }

  @Override
  public NPUResponseAssignmentExecutionSearch execute(
    final NPUserCommandContextType context,
    final NPUCommandAssignmentExecutionSearchNext command)
    throws NPException
  {
    ...
    try (var connection = context.databaseConnection()) {
      try (var transaction = connection.openTransaction()) {
        final var paged =
          context.property(NPAssignmentExecutionsPagedType.class)
            .orElseThrow(() -> {
