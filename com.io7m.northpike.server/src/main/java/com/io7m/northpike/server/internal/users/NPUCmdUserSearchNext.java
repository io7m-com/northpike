...
/**
 * @see NPUCommandUserSearchNext
 */

public final class NPUCmdUserSearchNext
  extends NPUCmdAbstract<NPUResponseUserSearch, NPUCommandUserSearchNext>
{
  /**
   * @see NPUCommandUserSearchNext
   */

  public NPUCmdUserSearchNext()
  {
    super(NPUCommandUserSearchNext.class);
  }

  @Override
  public NPUResponseUserSearch execute(
    final NPUserCommandContextType context,
    final NPUCommandUserSearchNext command)
    throws NPException
  {
