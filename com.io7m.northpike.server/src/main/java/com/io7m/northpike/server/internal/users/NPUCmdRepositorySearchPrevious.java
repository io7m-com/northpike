...
/**
 * @see NPUCommandRepositorySearchPrevious
 */

public final class NPUCmdRepositorySearchPrevious
  extends NPUCmdAbstract<NPUResponseRepositorySearch, NPUCommandRepositorySearchPrevious>
{
  /**
   * @see NPUCommandRepositorySearchPrevious
   */

  public NPUCmdRepositorySearchPrevious()
  {
    super(NPUCommandRepositorySearchPrevious.class);
  }

  @Override
  public NPUResponseRepositorySearch execute(
    final NPUserCommandContextType context,
    final NPUCommandRepositorySearchPrevious command)
    throws NPException
  {
    ...
    try (var connection = context.databaseConnection()) {
      try (var transaction = connection.openTransaction()) {
        final var paged =
          context.property(NPRepositoriesPagedType.class)
            .orElseThrow(() -> {
        ...
        return new NPUResponseRepositorySearch(
          UUID.randomUUID(),
          command.messageID(),
          paged.pagePrevious(transaction).map(NPRepositoryDescription::summary)
        );
      }
    }
  }
