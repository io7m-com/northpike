...
/**
 * @see NPUCommandUserSearchPrevious
 */

public final class NPUCmdUserSearchPrevious
  extends NPUCmdAbstract<NPUResponseUserSearch, NPUCommandUserSearchPrevious>
{
  /**
   * @see NPUCommandUserSearchPrevious
   */

  public NPUCmdUserSearchPrevious()
  {
    super(NPUCommandUserSearchPrevious.class);
  }

  @Override
  public NPUResponseUserSearch execute(
    final NPUserCommandContextType context,
    final NPUCommandUserSearchPrevious command)
    throws NPException
  {
    ...
    try (var transaction = context.transaction(NORTHPIKE_READ_ONLY)) {
      final var paged =
        context.property(NPUsersPagedType.class)
          .orElseThrow(() -> {
