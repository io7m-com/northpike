...
public final class NPArbUCommandAgentSearchBegin
  extends NPArbAbstract<NPUCommandAgentSearchBegin>
{
  public NPArbUCommandAgentSearchBegin()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.defaultFor(NPAgentSearchParameters.class)
        ).as(NPUCommandAgentSearchBegin::new);
      }
    );
  }
}
