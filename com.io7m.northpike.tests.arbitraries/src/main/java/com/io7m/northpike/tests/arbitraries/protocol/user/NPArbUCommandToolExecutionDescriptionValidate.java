...
public final class NPArbUCommandToolExecutionDescriptionValidate
  extends NPArbAbstract<NPUCommandToolExecutionDescriptionValidate>
{
  public NPArbUCommandToolExecutionDescriptionValidate()
  {
    super(
