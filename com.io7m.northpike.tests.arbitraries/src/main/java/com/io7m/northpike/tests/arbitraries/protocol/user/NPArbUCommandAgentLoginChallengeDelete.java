...
public final class NPArbUCommandAgentLoginChallengeDelete
  extends NPArbAbstract<NPUCommandAgentLoginChallengeDelete>
{
  public NPArbUCommandAgentLoginChallengeDelete()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandAgentLoginChallengeDelete::new);
      }
    );
  }
}
