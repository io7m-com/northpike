...
public final class NPArbUResponsePublicKeySearch
  extends NPArbAbstract<NPUResponsePublicKeySearch>
{
  public NPArbUResponsePublicKeySearch()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.create(UUID::randomUUID),
          page()
        ).as(NPUResponsePublicKeySearch::new);
      }
    );
  }
