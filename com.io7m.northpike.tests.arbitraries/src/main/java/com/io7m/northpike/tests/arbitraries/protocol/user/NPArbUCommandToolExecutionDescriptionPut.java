...
public final class NPArbUCommandToolExecutionDescriptionPut
  extends NPArbAbstract<NPUCommandToolExecutionDescriptionPut>
{
  public NPArbUCommandToolExecutionDescriptionPut()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandToolExecutionDescriptionPut::new);
      }
    );
  }
}
