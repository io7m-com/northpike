...
public final class NPArbACommandSWorkSent
  extends NPArbAbstract<NPACommandSWorkSent>
{
  public NPArbACommandSWorkSent()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.defaultFor(NPAgentWorkItem.class)
        ).as(NPACommandSWorkSent::new);
      }
    );
  }
}
