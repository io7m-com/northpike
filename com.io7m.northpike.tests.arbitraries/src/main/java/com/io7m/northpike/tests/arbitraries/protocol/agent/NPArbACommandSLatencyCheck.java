...
public final class NPArbACommandSLatencyCheck
  extends NPArbAbstract<NPACommandSLatencyCheck>
{
  public NPArbACommandSLatencyCheck()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPACommandSLatencyCheck::new);
      }
    );
  }
}
