...
public final class NPArbUCommandRepositoryPublicKeyUnassign
  extends NPArbAbstract<NPUCommandRepositoryPublicKeyUnassign>
{
  public NPArbUCommandRepositoryPublicKeyUnassign()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandRepositoryPublicKeyUnassign::new);
      }
    );
  }
}
