...
public final class NPArbWorkExecContainerImage
  extends NPArbAbstract<NPAWorkExecutorContainerImage>
{
  public NPArbWorkExecContainerImage()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.strings().alpha().ofMinLength(1),
          Arbitraries.strings().alpha().ofMinLength(1),
          Arbitraries.strings().alpha().ofMinLength(1).optional()
        ).as(NPAWorkExecutorContainerImage::new);
      }
    );
  }
}
