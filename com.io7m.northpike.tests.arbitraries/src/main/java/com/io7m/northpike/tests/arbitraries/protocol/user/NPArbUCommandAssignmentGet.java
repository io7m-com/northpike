...
public final class NPArbUCommandAssignmentGet
  extends NPArbAbstract<NPUCommandAssignmentGet>
{
  public NPArbUCommandAssignmentGet()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandAssignmentGet::new);
      }
    );
  }
}
