...
public final class NPArbACommandCEnvironmentInfo extends NPArbAbstract<NPACommandCEnvironmentInfo>
{
  public NPArbACommandCEnvironmentInfo()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.maps(Arbitraries.strings(), Arbitraries.strings())
        ).as(NPACommandCEnvironmentInfo::new);
      }
    );
  }
}
