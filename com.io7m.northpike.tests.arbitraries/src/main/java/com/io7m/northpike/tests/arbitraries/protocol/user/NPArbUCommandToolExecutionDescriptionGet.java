...
public final class NPArbUCommandToolExecutionDescriptionGet
  extends NPArbAbstract<NPUCommandToolExecutionDescriptionGet>
{
  public NPArbUCommandToolExecutionDescriptionGet()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandToolExecutionDescriptionGet::new);
      }
    );
  }
}
