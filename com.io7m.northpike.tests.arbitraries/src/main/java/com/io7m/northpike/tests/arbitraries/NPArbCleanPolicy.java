...
public final class NPArbCleanPolicy extends NPArbAbstract<NPCleanPolicyType>
{
  public NPArbCleanPolicy()
  {
    super(
      NPCleanPolicyType.class,
      () -> {
        return Arbitraries.oneOf(
          Arbitraries.create(() -> CLEAN_IMMEDIATELY),
          Arbitraries.create(() -> CLEAN_LATER)
        );
      }
    );
  }
