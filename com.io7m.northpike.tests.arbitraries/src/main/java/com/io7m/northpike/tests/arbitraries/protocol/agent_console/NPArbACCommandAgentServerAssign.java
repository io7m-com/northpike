...
public final class NPArbACCommandAgentServerAssign
  extends NPArbAbstract<NPACCommandAgentServerAssign>
{
  public NPArbACCommandAgentServerAssign()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPACCommandAgentServerAssign::new);
      }
    );
  }
}
