...
public final class NPArbACommandCWorkItemStarted
  extends NPArbAbstract<NPACommandCWorkItemStarted>
{
  public NPArbACommandCWorkItemStarted()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPACommandCWorkItemStarted::new);
      }
    );
  }
}
