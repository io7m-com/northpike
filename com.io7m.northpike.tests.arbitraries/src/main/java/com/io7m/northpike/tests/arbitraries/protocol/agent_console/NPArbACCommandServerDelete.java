...
public final class NPArbACCommandServerDelete extends NPArbAbstract<NPACCommandServerDelete>
{
  public NPArbACCommandServerDelete()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPACCommandServerDelete::new);
      }
    );
  }
}
