...
public final class NPArbACResponseServerList extends NPArbAbstract<NPACResponseServerList>
{
  public NPArbACResponseServerList()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.create(UUID::randomUUID),
          Arbitraries.defaultFor(NPAgentServerSummary.class).list()
        ).as(NPACResponseServerList::new);
      }
    );
  }
}
