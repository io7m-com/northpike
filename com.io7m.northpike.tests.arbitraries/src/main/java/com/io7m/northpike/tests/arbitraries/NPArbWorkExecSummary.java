...
public final class NPArbWorkExecSummary extends NPArbAbstract<NPAWorkExecutorSummary>
{
  public NPArbWorkExecSummary()
  {
    super(
      NPAWorkExecutorSummary.class,
      () -> {
        return Combinators.combine(
          Arbitraries.defaultFor(NPAWorkExecName.class),
          Arbitraries.strings().alpha(),
          Arbitraries.defaultFor(NPAWorkExecutorPropertyType.class).set()
        ).as(NPAWorkExecutorSummary::new);
      }
    );
  }
}
