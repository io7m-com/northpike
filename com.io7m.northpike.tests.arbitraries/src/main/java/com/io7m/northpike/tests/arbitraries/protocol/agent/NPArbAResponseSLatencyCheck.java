...
public final class NPArbAResponseSLatencyCheck
  extends NPArbAbstract<NPAResponseLatencyCheck>
{
  public NPArbAResponseSLatencyCheck()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.defaultFor(OffsetDateTime.class)
        ).as(NPAResponseLatencyCheck::new);
      }
    );
  }
}
