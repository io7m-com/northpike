...
public final class NPArbAgentDescription
  extends NPArbAbstract<NPAgentDescription>
{
  public NPArbAgentDescription()
  {
    super(
      NPAgentDescription.class,
      () -> {
