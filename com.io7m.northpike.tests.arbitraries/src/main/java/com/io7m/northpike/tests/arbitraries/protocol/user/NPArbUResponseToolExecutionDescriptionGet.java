...
public final class NPArbUResponseToolExecutionDescriptionGet
  extends NPArbAbstract<NPUResponseToolExecutionDescriptionGet>
{
  public NPArbUResponseToolExecutionDescriptionGet()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.defaultFor(NPToolExecutionDescription.class)
            .optional()
        ).as(NPUResponseToolExecutionDescriptionGet::new);
      }
    );
  }
}
