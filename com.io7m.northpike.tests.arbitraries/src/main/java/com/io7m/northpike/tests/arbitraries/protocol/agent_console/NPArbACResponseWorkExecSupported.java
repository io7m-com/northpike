...
public final class NPArbACResponseWorkExecSupported
  extends NPArbAbstract<NPACResponseWorkExecSupported>
{
  public NPArbACResponseWorkExecSupported()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.create(UUID::randomUUID),
          Arbitraries.defaultFor(NPAWorkExecutorSummary.class).list()
        ).as(NPACResponseWorkExecSupported::new);
      }
    );
  }
}
