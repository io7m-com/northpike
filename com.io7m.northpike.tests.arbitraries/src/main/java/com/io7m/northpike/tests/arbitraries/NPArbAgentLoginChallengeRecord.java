...
public final class NPArbAgentLoginChallengeRecord
  extends NPArbAbstract<NPAgentLoginChallengeRecord>
{
  public NPArbAgentLoginChallengeRecord()
  {
    super(
      NPAgentLoginChallengeRecord.class,
      () -> {
        return Combinators.combine(
          Arbitraries.create(OffsetDateTime::now),
          Arbitraries.strings(),
          Arbitraries.defaultFor(NPAgentKeyPublicType.class),
          Arbitraries.defaultFor(NPAgentLoginChallenge.class)
        ).as(NPAgentLoginChallengeRecord::new);
      }
    );
  }
}
