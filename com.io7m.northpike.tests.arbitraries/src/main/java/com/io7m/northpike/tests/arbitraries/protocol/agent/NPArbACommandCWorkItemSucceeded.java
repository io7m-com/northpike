...
public final class NPArbACommandCWorkItemSucceeded
  extends NPArbAbstract<NPACommandCWorkItemSucceeded>
{
  public NPArbACommandCWorkItemSucceeded()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPACommandCWorkItemSucceeded::new);
      }
    );
  }
}
