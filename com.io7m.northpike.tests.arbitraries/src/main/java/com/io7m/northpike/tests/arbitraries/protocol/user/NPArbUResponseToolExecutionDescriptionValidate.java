...
public final class NPArbUResponseToolExecutionDescriptionValidate
  extends NPArbAbstract<NPUResponseToolExecutionDescriptionValidate>
{
  public NPArbUResponseToolExecutionDescriptionValidate()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.create(UUID::randomUUID),
          errors().list()
        ).as(NPUResponseToolExecutionDescriptionValidate::new);
      }
    );
  }
