...
public final class NPArbEVariableString extends NPArbAbstract<NPTXEVariableString>
{
  public NPArbEVariableString()
  {
    super(
      NPTXEVariableString.class,
      () -> {
        return Combinators.combine(
          Arbitraries.defaultFor(LexicalPosition.class),
          Arbitraries.defaultFor(RDottedName.class)
        ).as(NPTXEVariableString::new);
      }
    );
  }
}
