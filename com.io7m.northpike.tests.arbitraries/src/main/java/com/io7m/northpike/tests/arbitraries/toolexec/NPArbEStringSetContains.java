...
public final class NPArbEStringSetContains
  extends NPArbAbstract<NPTXEStringSetContains>
{
  public NPArbEStringSetContains()
  {
    super(
      NPTXEStringSetContains.class,
      () -> {
