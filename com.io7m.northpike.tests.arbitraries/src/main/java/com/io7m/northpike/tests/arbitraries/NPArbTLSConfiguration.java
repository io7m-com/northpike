...
public final class NPArbTLSConfiguration
  extends NPArbAbstract<NPTLSConfigurationType>
{
  public NPArbTLSConfiguration()
  {
    super(
      NPTLSConfigurationType.class,
      () -> {
        return Arbitraries.oneOf(
          Arbitraries.create(() -> {
            return NPTLSDisabled.TLS_DISABLED;
          }),
          Combinators.combine(
