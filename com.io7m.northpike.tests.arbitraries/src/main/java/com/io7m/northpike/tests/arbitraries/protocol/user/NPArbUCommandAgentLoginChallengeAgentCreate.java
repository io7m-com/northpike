...
public final class NPArbUCommandAgentLoginChallengeAgentCreate
  extends NPArbAbstract<NPUCommandAgentLoginChallengeAgentCreate>
{
  public NPArbUCommandAgentLoginChallengeAgentCreate()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandAgentLoginChallengeAgentCreate::new);
      }
    );
  }
}
