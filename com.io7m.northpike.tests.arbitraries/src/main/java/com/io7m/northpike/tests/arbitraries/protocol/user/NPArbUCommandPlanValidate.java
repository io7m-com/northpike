...
public final class NPArbUCommandPlanValidate
  extends NPArbAbstract<NPUCommandPlanValidate>
{
  public NPArbUCommandPlanValidate()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.defaultFor(NPPlanDescriptionUnparsed.class)
        ).as(NPUCommandPlanValidate::new);
      }
    );
  }
}
