...
public final class NPArbUCommandAgentLabelPut
  extends NPArbAbstract<NPUCommandAgentLabelPut>
{
  public NPArbUCommandAgentLabelPut()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandAgentLabelPut::new);
      }
    );
  }
}
