...
public final class NPArbUCommandRepositoryPublicKeyAssign
  extends NPArbAbstract<NPUCommandRepositoryPublicKeyAssign>
{
  public NPArbUCommandRepositoryPublicKeyAssign()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandRepositoryPublicKeyAssign::new);
      }
    );
  }
}
