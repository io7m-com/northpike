...
public final class NPArbEVariableInteger extends NPArbAbstract<NPTXEVariableInteger>
{
  public NPArbEVariableInteger()
  {
    super(
      NPTXEVariableInteger.class,
      () -> {
        return Combinators.combine(
          Arbitraries.defaultFor(LexicalPosition.class),
          Arbitraries.defaultFor(RDottedName.class)
        ).as(NPTXEVariableInteger::new);
      }
    );
  }
}
