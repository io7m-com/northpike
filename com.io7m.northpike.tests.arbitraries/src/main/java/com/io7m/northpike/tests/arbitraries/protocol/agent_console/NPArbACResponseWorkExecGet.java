...
public final class NPArbACResponseWorkExecGet
  extends NPArbAbstract<NPACResponseWorkExecGet>
{
  public NPArbACResponseWorkExecGet()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.create(UUID::randomUUID),
          Arbitraries.defaultFor(NPAWorkExecutorSummary.class).optional()
        ).as(NPACResponseWorkExecGet::new);
      }
    );
  }
}
