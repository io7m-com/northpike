...
public final class NPArbFailurePolicy extends NPArbAbstract<NPFailurePolicyType>
{
  public NPArbFailurePolicy()
  {
    super(
      NPFailurePolicyType.class,
      () -> {
        return Arbitraries.oneOf(
          Arbitraries.create(() -> FAIL),
          Arbitraries.create(() -> IGNORE_FAILURE),
          Arbitraries.integers()
            .greaterOrEqual(0)
            .map(NPFailureRetry::new)
        );
      }
    );
  }
