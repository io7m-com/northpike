...
public final class NPArbACommandCWorkItemFailed
  extends NPArbAbstract<NPACommandCWorkItemFailed>
{
  public NPArbACommandCWorkItemFailed()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPACommandCWorkItemFailed::new);
      }
    );
  }
}
