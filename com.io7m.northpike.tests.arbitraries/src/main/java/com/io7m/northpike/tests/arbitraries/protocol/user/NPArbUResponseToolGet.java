...
public final class NPArbUResponseToolGet
  extends NPArbAbstract<NPUResponseToolGet>
{
  public NPArbUResponseToolGet()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.create(UUID::randomUUID),
          Arbitraries.defaultFor(NPToolDescription.class).optional()
        ).as(NPUResponseToolGet::new);
      }
    );
  }
}
