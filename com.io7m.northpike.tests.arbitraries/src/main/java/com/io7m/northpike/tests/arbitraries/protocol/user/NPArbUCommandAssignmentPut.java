...
public final class NPArbUCommandAssignmentPut
  extends NPArbAbstract<NPUCommandAssignmentPut>
{
  public NPArbUCommandAssignmentPut()
  {
    super(
      ...
      () -> {
        ...
        ).as(NPUCommandAssignmentPut::new);
      }
    );
  }
}
