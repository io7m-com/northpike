...
public final class NPArbEVariableBoolean extends NPArbAbstract<NPTXEVariableBoolean>
{
  public NPArbEVariableBoolean()
  {
    super(
      NPTXEVariableBoolean.class,
      () -> {
        return Combinators.combine(
          Arbitraries.defaultFor(LexicalPosition.class),
          Arbitraries.defaultFor(RDottedName.class)
        ).as(NPTXEVariableBoolean::new);
      }
    );
  }
}
