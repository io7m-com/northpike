...
public final class NPArbUCommandPlanSearchBegin
  extends NPArbAbstract<NPUCommandPlanSearchBegin>
{
  public NPArbUCommandPlanSearchBegin()
  {
    super(
      ...
      () -> {
        return Combinators.combine(
          ...
          Arbitraries.defaultFor(NPPlanSearchParameters.class)
        ).as(NPUCommandPlanSearchBegin::new);
      }
    );
  }
}
