...
public final class NPArbStatementType
  extends NPArbAbstract<NPTXStatementType>
{
  public NPArbStatementType()
  {
    super(
      ...
      () -> {
        return Arbitraries.oneOf(
          ...
          Arbitraries.defaultFor(NPTXSEnvironmentRemove.class),
          Arbitraries.defaultFor(NPTXSEnvironmentSet.class),
          Arbitraries.defaultFor(NPTXSIf.class)
        );
      }
    );
  }
