...
public final class NPArbEVariableStringSet
  extends NPArbAbstract<NPTXEVariableStringSet>
{
  public NPArbEVariableStringSet()
  {
    super(
      NPTXEVariableStringSet.class,
      () -> {
        return Combinators.combine(
          Arbitraries.defaultFor(LexicalPosition.class),
          Arbitraries.defaultFor(RDottedName.class)
        ).as(NPTXEVariableStringSet::new);
      }
    );
  }
}
