 ...
 * {@link com.io7m.northpike.database.api.NPDatabaseTransactionType#queries(Class)}),
 * and a function that yields a query when supplied with a transaction.
 */

public interface NPDBQueryProviderType
{
  /**
  ...
  record Service<P, R, Q extends NPDatabaseQueryType<P, R>>(
    Class<Q> interfaceClass,
    Function<NPDatabaseTransaction, Q> constructor)
  {
    /**
     * The query provider information.
     */
