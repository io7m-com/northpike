...
public enum NPAVWorkItemIdentifier
  implements NPProtocolMessageValidatorType<NPWorkItemIdentifier, NPA1WorkItemIdentifier>
{
  /**
   * A validator.
   */
  ...
  @Override
  public NPA1WorkItemIdentifier convertToWire(
