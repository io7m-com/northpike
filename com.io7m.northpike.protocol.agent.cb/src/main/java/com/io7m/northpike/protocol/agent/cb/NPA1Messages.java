...
public final class NPA1Messages
  implements NPProtocolMessagesType<NPAMessageType>, RPServiceType
{
  private static final ProtocolNPA PROTOCOL = new ProtocolNPA();
  ...
  public static final String CONTENT_TYPE =
    "application/northpike_agent+cedarbridge";

  private final BSSReaderProviderType readers;
  private final BSSWriterProviderType writers;
  private final NPA1Validation validator;
  private final CBProtocolMessageVersionedSerializerType<ProtocolNPAType> serializer;
    ...
    final BSSWriterProviderType inWriters)
  {
    ...
    this.validator = new NPA1Validation();
    this.serializer =
    ...
    throws NPProtocolException
  {
    ...
    try {
      return this.validator.convertFromWire(
        (ProtocolNPAv1Type) this.serializer.deserialize(context)
      );
