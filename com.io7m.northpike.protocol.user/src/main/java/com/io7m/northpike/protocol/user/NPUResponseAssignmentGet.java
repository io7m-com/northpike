...
public record NPUResponseAssignmentGet(
  UUID messageID,
  UUID correlationID,
  Optional<NPAssignment> assignment)
  implements NPUResponseType
{
  ...
  public NPUResponseAssignmentGet
  {
  ...
  public static NPUResponseAssignmentGet createCorrelated(
    final NPUCommandType<?> command,
    final Optional<NPAssignment> assignment)
  {
