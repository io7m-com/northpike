...
public record NPUResponsePlanFormatsSupported(
  UUID messageID,
  UUID correlationID,
  ...
  implements NPUResponseType
{
  ...
  public NPUResponsePlanFormatsSupported
  {
  ...
  public static NPUResponsePlanFormatsSupported createCorrelated(
    final NPUCommandType<?> command,
    final Set<NPPlanFormatDescription> providers)
  {
