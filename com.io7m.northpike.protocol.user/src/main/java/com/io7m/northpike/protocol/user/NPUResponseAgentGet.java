...
public record NPUResponseAgentGet(
  UUID messageID,
  UUID correlationID,
  Optional<NPAgentDescription> agent)
  implements NPUResponseType
{
  ...
  public static NPUResponseAgentGet createCorrelated(
    final NPUCommandType<?> command,
    final Optional<NPAgentDescription> agent)
  {
