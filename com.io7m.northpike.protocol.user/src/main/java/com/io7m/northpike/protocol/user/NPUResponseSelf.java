  ...
  implements NPUResponseType
{
  ...
  public static NPUResponseSelf createCorrelated(
    final NPUCommandType<?> command,
    final UUID userId)
  {
    return new NPUResponseSelf(UUID.randomUUID(), command.messageID(), userId);
  }
}
